<template>
    <div style="width: 200px; height: 250px; background: white; position: relative" ref="root">
...
onMounted(() => {
    ...
    rootEl.querySelectorAll<HTMLDivElement>(':scope .layer-effect .item').forEach(el => {
